...
class CompDataAnalysis:
    ...
    def calc_ebit(self, 
        ...
        interest_exp     = df.loc["interest exp.(inc.),net-operating, total"].fillna(0)
        # interset_inc     = df.loc["interest inc.(exp.),net-non-op., total"].fillna(0)
        interest_exp *= -1
        # interset_inc *= -1
        
        return operating_income + interest_exp 
...
temp_c.calc_assetst()
print(temp_c.calc_ROA(temp_c.BAL))
